...
cd "$CACHEDIR"
rm $FILE
URL=https://download.jetbrains.com/idea/ideaIC-2016.3.4.tar.gz
FILE=ideaIC.tar.gz
...
ln -sf /opt/intellij/idea-IC-163.12024.16/bin/idea.sh /usr/bin/intellij

xdg-icon-resource install --novendor --size 256 "/opt/intellij/idea-IC-163.12024.16/bin/idea.png" "intellij"
